...
public class UsuarioPremioVO {
	...
	public UsuarioPremioVO(UsuarioVO usuario, PremioVO premio, LocalDate fecha) {
		super();
	...
	public UsuarioPremioVO(int idUsuPre, UsuarioVO usuario, PremioVO premio, LocalDate fecha) {
		super();
